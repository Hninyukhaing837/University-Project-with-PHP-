...
$get_id=$_REQUEST['id'];
$result = $conn->prepare("SELECT * FROM tinfo_tbl Where id ='$get_id'  ");
$result->execute();
$row = $result->fetch();
$id=$row['id'];
?>
...
<table border="0" align="center" cellspacing="20px" style="padding:3em; width: 55%;">
  ...
  <tr   style="padding:3em; padding-bottom:3em;">
    <th width="20%" height="50" align="left" scope="row">Teacher Name:</th>
    <td width="30%" style="border-bottom: 2px solid #6e02b2;" valign="bottom"><?php echo $row['tname']; ?> </td>
    <th width="20%" align="left" style="padding:20px;"><strong>Department:</strong></th>
    <td width="30%" style="border-bottom: 2px solid #6e02b2;" valign="bottom"><?php echo $row['major']; ?></td>
	  </tr >
	 <br>
	<br>
   <tr   style="padding:3em;">
    <th align="left" height="50" scope="row">Position:</th>
    <td style="border-bottom: 2px solid #6e02b2;" valign="bottom"><?php echo $row['position']; ?></td>
    <th align="left" style="padding:20px;">Date of Birth:</th>
    <td style="border-bottom: 2px solid #6e02b2;" valign="bottom"><?php echo $row['bdate']; ?></td>
  </tr>
  <tr border="4">
  <th align="left"><strong>Age:</strong></th>
    <td style="border-bottom: 2px solid #6e02b2;" valign="bottom"><?php echo $row['age']; ?></td>
    <th align="left" height="50" scope="row" style="padding:20px;">Work Age:</th>
    <td style="border-bottom: 2px solid #6e02b2;" valign="bottom"><?php echo $row['work_age']; ?></td>
   </tr>
  
  <tr border="4">
    <th align="left" height="50" scope="row">Past University:</th>
    <td style="border-bottom: 2px solid #6e02b2;" valign="bottom"><?php echo $row['l_uni']; ?></td>
    <th align="left" style="padding:20px;"><strong>gender:</strong></th>
	<?php if( $row['gender'] == 0){ ?>
	...
	?>
  <tr border="4">
    <th align="left" height="50" scope="row" >Contact Number:</th>
    <td style="border-bottom: 2px solid #6e02b2;" valign="bottom"><?php echo $row['ph_num']; ?></td>
...
<tr><td colspan="4" height="60"><a href="teacher.php" class="btn btn-md btn-primary display-4" style=" float:right; text-shadow: 0 3px 3px rgba(0,0,0,0.8);">Back Page</a></td></tr>
</table>
