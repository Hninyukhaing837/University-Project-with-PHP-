...
<br><br>
   <div class="page-404">
    <p class="text-404">ERR!</p>

    <h2>Sorry!</h2>
    <p>This page doesn’t exist yet. Please try later! <br><a href="department.php">Return to back page</a></p>
  </div>
<br>

<section class="cid-qwvPZuffW8" id="footer1-24" data-rv-view="754">
