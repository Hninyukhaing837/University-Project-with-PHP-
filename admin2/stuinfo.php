...
<!-- Advanced Tables -->
                    <center> <div class="panel panel-default" style="width:95%; float:center;" align="center">
                        <div class="panel-heading" style="font-size:22px; color: #19abff; text-shadow: 0 3px 3px rgba(0,0,0,0.5); padding:10px;">
                          <strong>  Information of university students </strong><p style="float:right;"><?php include ('smodal_add.php'); ?><p>
                        </div>
    ...
    <thead>
    	<tr style="font-size:20px; color: #7198c1; text-shadow: 0 3px 3px rgba(0,0,0,0.5);">
			<td scope="col">Roll Number</td>
...
$query = "SELECT * FROM stu_tbl WHERE major='$major' AND year='$year'";
	...
	while($row=$stmt->fetch(PDO::FETCH_ASSOC)) {
		...
		?>
   <tbody>
<tr  style="font-size:18px; color: #7a7a7a;"><td><?php echo $row['rollnum']?></td>
                              ...
                              <div class="modal fade" id="delete<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            <a href="sdelete.php<?php echo '?id='.$id; ?>"><button class="btn btn-danger" type="button">Yes</button></a>
                                          </div>
                                      </div>
                                  </div>
                              </div>
